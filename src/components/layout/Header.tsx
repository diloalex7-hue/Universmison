    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/60 bg-background/85 backdrop-blur-xl">
      <div className="container-luxe">
        ...
        <div className="flex h-16 items-center justify-between gap-4 md:h-20">
          {/* Mobile menu (hidden on native apps since we use BottomNav) */}
          {!isNative && (
          ...
          <Link to="/" className="flex items-center gap-3 shrink-0">
            <img src="/logo.png" alt="Univers Maison Logo" className="h-12 w-auto object-contain drop-shadow-sm" />
            <div className="leading-none hidden sm:block">
              <div className="font-serif text-xl font-medium tracking-tight">Univers <span className="text-gold">Maison</span></div>
              <div className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground">Art de la table</div>
            </div>
          </Link>
