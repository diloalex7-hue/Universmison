...
const dict: Dict = {
  ...
  "auth.reset_desc": { fr: "Entrez votre adresse e-mail et nous vous enverrons un lien pour réinitialiser votre mot de passe.", ar: "أدخل بريدك الإلكتروني وسنرسل لك رابطاً لإعادة تعيين كلمة المرور الخاصة بك.", en: "Enter your email address and we will send you a link to reset your password." },
  "auth.check_email": { fr: "Vérifiez vos e-mails", ar: "تحقق من بريدك الإلكتروني", en: "Check your email" },
  "auth.reset_sent": { fr: "Si un compte existe pour", ar: "إذا كان هناك حساب مسجل بـ", en: "If an account exists for" },
  "auth.reset_sent_2": { fr: "nous vous avons envoyé des instructions pour réinitialiser votre mot de passe.", ar: "فقد أرسلنا لك تعليمات لإعادة تعيين كلمة المرور الخاصة بك.", en: "we have sent you instructions to reset your password." },
  "auth.try_another": { fr: "Essayer une autre adresse e-mail", ar: "جرب عنوان بريد إلكتروني آخر", en: "Try another email address" },
  "auth.send_link": { fr: "Envoyer le lien", ar: "إرسال الرابط", en: "Send link" },
  "auth.sending": { fr: "Envoi en cours...", ar: "جاري الإرسال...", en: "Sending..." },
  "auth.back_login": { fr: "Retour à la connexion", ar: "العودة لتسجيل الدخول", en: "Back to login" },
  "auth.new_password": { fr: "Nouveau mot de passe", ar: "كلمة مرور جديدة", en: "New password" },
  "auth.new_password_desc": { fr: "Veuillez entrer votre nouveau mot de passe ci-dessous.", ar: "يرجى إدخال كلمة المرور الجديدة أدناه.", en: "Please enter your new password below." },
  "auth.confirm_logout": { fr: "Êtes-vous sûr de vouloir vous déconnecter ?", ar: "هل أنت متأكد أنك تريد تسجيل الخروج؟", en: "Are you sure you want to log out?" },
  "auth.confirm_password": { fr: "Confirmer le mot de passe", ar: "تأكيد كلمة المرور", en: "Confirm password" },
  "auth.update_password": { fr: "Mettre à jour le mot de passe", ar: "تحديث كلمة المرور", en: "Update password" },
  "auth.updating": { fr: "Mise à jour...", ar: "جاري التحديث...", en: "Updating..." },
  ...
  "status.pending.desc": { fr: "Votre commande a été reçue et est en cours de traitement.", ar: "تم استلام طلبك وجاري معالجته.", en: "Your order has been received and is being processed." },
  "status.confirmed.desc": { fr: "Votre commande est confirmée et en préparation.", ar: "تم تأكيد طلبك وجاري تحضيره.", en: "Your order is confirmed and being prepared." },
  "status.shipped.desc": { fr: "Votre commande est en route vers vous !", ar: "طلبك في الطريق إليك!", en: "Your order is on its way to you!" },
  "status.delivered.desc": { fr: "Votre commande a été livrée avec succès.", ar: "تم توصيل طلبك بنجاح.", en: "Your order has been delivered successfully." },
  "status.cancelled.desc": { fr: "Cette commande a été annulée.", ar: "تم إلغاء هذا الطلب.", en: "This order has been cancelled." },

  "coupon.code": { fr: "Code promo", ar: "رمز الخصم", en: "Promo code" },
  "coupon.apply": { fr: "Appliquer", ar: "تطبيق", en: "Apply" },
  "coupon.applied": { fr: "Code promo appliqué !", ar: "تم تطبيق رمز الخصم!", en: "Promo code applied!" },
  "coupon.invalid": { fr: "Code promo invalide ou expiré.", ar: "رمز الخصم غير صالح أو منتهي الصلاحية.", en: "Invalid or expired promo code." },
  "coupon.min_order": { fr: "Montant minimum requis :", ar: "الحد الأدنى للطلب:", en: "Minimum order required:" },
  "coupon.discount": { fr: "Remise", ar: "خصم", en: "Discount" },
  "coupon.remove": { fr: "Retirer", ar: "إزالة", en: "Remove" },

  "fav.price_drop": { fr: "Prix en baisse !", ar: "انخفاض في السعر!", en: "Price drop!" },
  "fav.price_was": { fr: "Était", ar: "كان", en: "Was" },
